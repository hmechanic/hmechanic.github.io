      ...
      areas: [
        {
          ...
          content: (
            <>
              ...
              relacionados con energía, cambio climático, análisis de datos y modelación de
              sistemas.
            </>
          ),
        },
        {
          ...
          content: (
            <>
              La segunda es el desarrollo de software complejo para resolver problemas de ingeniería
              y construir productos tecnológicos. En esta área implemento tecnologías relacionadas
              con el análisis y la gestión de datos, el desarrollo de software y la creación de
              proyectos <span className="text-neon-magenta font-bold">AI First</span>, incluyendo
              programación de agentes, diseño de arquitecturas de machine learning, automatización
      ...
      details: [
        {
          ...
          content: (
            <>
              Mi formación complementaria incluye inteligencia artificial, machine learning,
              análisis de datos e ingeniería de software. Entre mis trabajos recientes se encuentran
              dos proyectos principales: <span className="text-white font-semibold">SatEmis</span>,
              una plataforma orientada a la investigación climática, el análisis de datos
              satelitales y la aplicación de modelos de machine learning a escala; y{' '}
              ...
              dirigido a empresas con necesidades intensivas de atención y gestión de usuarios.
        ...
        },
        {
          ...
          content: (
            <>
              ...
              en la construcción de soluciones que integran datos, inteligencia artificial, software
              e ingeniería aplicada.
            </>
          ),
        },
      ],
    ...
    hero: {
      ...
      tagline: (
        <>
          ...
          <p>
            I use technology, creativity, my analytical skills and a passionate approach to
            challenges to help create and sustain a world with values, dreams and awareness.
          </p>
          <p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <span className="text-neon-magenta font-bold">AI First</span> projects, including
              agent programming, machine learning architecture design, process automation and
              systems integration.
            </>
          ),
        },
      ...
      details: [
        {
          ...
          content: (
            <>
              ...
              <span className="text-white font-semibold">SatEmis</span>, a platform focused on
              climate research, satellite data analysis and the large-scale application of machine
              learning models; and{' '}
              <span className="text-white font-semibold">OrionAtiende.com</span>, a SaaS platform
              for the tailored implementation of specialised sales and customer support agents,
              aimed at companies with intensive customer service and user-management needs. Both
              projects can be explored in greater detail in the projects section.
            </>
          ),
        },
        {
          ...
          content: (
            <>
              ...
              emphasis on thermal and fluid-related fields. My work includes renewable energy,
              energy modelling, computational fluid dynamics (
        ...
        },
        {
          ...
          content: (
            <>
              In software, I work as a lead engineer in the design and development of projects. I
              have nearly four years of certified experience and specialise in building solutions
              that integrate data, artificial intelligence, software and applied engineering.
            </>
          ),
        },
      ],
